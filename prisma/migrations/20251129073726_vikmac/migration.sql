...
-- CreateIndex
CREATE INDEX "AutoApplication_careerId_idx" ON "AutoApplication"("careerId");
...
-- CreateIndex
CREATE UNIQUE INDEX "AutoApplication_applicantId_careerId_key" ON "AutoApplication"("applicantId", "careerId");
...
-- AddForeignKey
ALTER TABLE "AutoApplication" ADD CONSTRAINT "AutoApplication_careerId_fkey" FOREIGN KEY ("careerId") REFERENCES "Career"("id") ON DELETE CASCADE ON UPDATE CASCADE;
